...
def Q_learning(env,learning_rate = 0.1, discount_factor = 0.9, epsilon = 0.75, num_episodes = 3000):
    # Setting Q
...
# SARSA
def sarsa(env, learning_rate=0.1, discount_factor=0.9, epsilon=0.3, num_episodes = 1000):
    state_space = env.num_states.n
    action_space = env.action_space.n
...
def first_visit_monte_carlo(env, num_episodes, epsilon=0.5):
    state_space = env.num_states.n
    action_space = env.action_space.n
